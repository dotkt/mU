...
namespace mU {
	...
	mpz_ptr* poly_z::elts() { return empty() ? 0 : &((*this)[0]); }
	mpz_ptr const* poly_z::elts() const { return empty() ? 0 : &((*this)[0]); }
	...
	void UniMulZp(poly_z & r,const poly_z & f,const poly_z & g,mpz_ptr p) {
		UniMulZ(r, f, g);
	...
	void UniAddZp(poly_z & r,const poly_z & f,const poly_z & g,mpz_ptr p) {
		UniAddZ(r, f, g);
		UniPolynomialMod(r, r, p);
	}
	...
	void UniSubZp(poly_z & r,const poly_z & f,const poly_z & g,mpz_ptr p) {
		UniSubZ(r, f, g);
		UniPolynomialMod(r, r, p);
	}
	...
	void UniReExactZ(poly_z & r,const poly_z & f,const poly_z & g)
	{
		poly_z q,rr;
		UniDivExactZ(q,f,g);
		UniMulZ(rr,q,g);
